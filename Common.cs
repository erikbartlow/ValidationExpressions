...
namespace CodedThought.Core.Validation {
    ...
    public enum ExpressionFlags {
        /// <summary>
        /// When available this flag will force the evaluator to apply the modifier to the value.
        /// </summary>
        Force = 1,
        None = 2
    }
    ...
    public enum ExpressionModifiers {
        /// <summary>
        /// Convert case of the target to upper case.
        /// </summary>
        Uppercase = 1,
        /// <summary>
        /// Convert the case of the target to lower case.
        /// </summary>
        Lowercase = 2,
        /// <summary>
        /// Do not consider case.
        /// </summary>
        CaseInsensitive = 4,
        /// <summary>
        ...
        RoundUp = 8,
        /// <summary>
        /// Round the decimal down to the nears whole number.
        /// </summary>
        RoundDown = 16,
        /// <summary>
        /// The maximum value the target can be, or the maximum length if the target is a string.
        /// </summary>
        Max = 32,
        /// <summary>
        /// The minimum value the target can be, or the minimum length if the target is a string.
        /// </summary>
        Min = 64,
        /// <summary>
        /// The target must be between the passed arguments.
        /// </summary>
        Between = 128,
        /// <summary>
        /// The target must comply with an email format.
        /// </summary>
        Email = 256,
        /// <summary>
        /// Must have a value.
        ...
        Required = 512,
        /// <summary>
        /// The target must contain the value in the string.
        /// </summary>
        Contains = 1024,
        /// <summary>
        /// The target must be one of the values in the parameter list.
        /// </summary>
        In = 2048,
        /// <summary>
        /// The target must be one of the values in the parameter list obtined from a DB table.
        /// </summary>
        InDB = 4096,
    ...
    public enum TargetTypeEnum {
        /// <summary>
        /// The test target value is numerically based.
        /// </summary>
        Numeric = 1,
        /// <summary>
        /// The test target value is text based.
        /// </summary>
        Text = 2,
        /// <summary>
        /// The test target value is date based.
        /// </summary>
        Date = 3
    }
    ...
    public static class Common {
        ...
        /// <summary>
        /// Gets the value system type for proper comparisons.
        /// </summary>
        ...
        /// <summary>
        /// Gets the value system as the expected type.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Gets or sets the path to business logic plugins.
        /// </summary>
        /// <value>
        /// The path to business logic plugins.
        /// </value>
        public static string PathToBusinessLogicPlugins { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether the validation
        /// will run in via an automated process.  This will disable
        /// the SmartUpload Access checks.
        /// </summary>
        /// <value>
        ///   <c>true</c> if [run automated]; otherwise, <c>false</c>.
        /// </value>
        public static bool RunAutomated { get; set; }


        /// <summary>
        /// Determins if the passed row marks the end of the table.
        /// </summary>
