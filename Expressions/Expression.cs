...
namespace CodedThought.Core.Validation.Expressions {
    public class Expression {
        ...
        private List<object> _modifierParameters = new List<object>();
        private ExpressionOperands _operand = ExpressionOperands.Equals;

        /// <summary>
        /// Gets a value indicating whether this instance refers to "this" instead of a passed target value.
        /// </summary>
        /// <value>
        ...
        public object[] ModifierParameters {
            get {
                if (_modifierParameters.Count == 0) {
                    return new object[0];
                } else {
                    return _modifierParameters.ToArray<object>();
                }
            }
        }
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the expression's original pattern string.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Gets or sets the exceptions if the <c>Test</c> method results in a <c>false</c>.
        /// </summary>
        /// <value>
        /// The exceptions.
        /// </value>
        ...
        /// <summary>
        /// Gets a value indicating whether this instance is valid based on the expression.
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is valid; otherwise, <c>false</c>.  If <c>false</c> then the Exceptions list property will have 1 or more exceptions.
        /// </value>
        ...
        /// The Max, Min, Between modifiers require numeric values to validate against.
        /// </exception>
        /// <exception cref="System.ArgumentException">
        /// The Between modifier must be used in conjunction with numeric type values only.
        /// or
        /// The Email modifier must be applied to text based values only.
        /// </exception>
        private bool ApplyModifier(object value) {
            ...
            foreach (ExpressionModifiers mod in Extensions.EnumToList<ExpressionModifiers>()) {
                // Assume it will pass.
                ValidationResult result = new ValidationResult() { Result = ValidationResultTypes.PASS };
        ...
        /// </summary>
        /// <param name="htmlFormatted">if set to <c>true</c> the return string will have HTML formatting for
        /// use on a web page.  Otherwise the messages will be delimited by a semi-colon</param>
